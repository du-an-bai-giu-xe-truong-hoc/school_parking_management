...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"D:\Python_Code\AI_Project\App_Python\ten_file_key_cua_ngai.json"

try:
    # Nhớ dùng file best.pt đã huấn luyện nhận diện biển số của ngài
    plate_detector = YOLO(r'D:\Python_Code\AI_Project\App_Python\best.pt') 
