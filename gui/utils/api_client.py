...
class ApiClient:
    ...
    @staticmethod
    def emergency_open(lane: str, gate_type: str) -> Optional[Dict[str, Any]]:
        payload = {"lane": lane, "gate_type": gate_type}
        return ApiClient._request("POST", "/parking/emergency-open", json=payload)
